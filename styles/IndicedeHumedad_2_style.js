...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.194464 && value <= -0.090250) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.090250 && value <= 0.013964) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.013964 && value <= 0.118178) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.118178 && value <= 0.222392) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.222392 && value <= 0.326606) {
            style = [ new ol.style.Style({
