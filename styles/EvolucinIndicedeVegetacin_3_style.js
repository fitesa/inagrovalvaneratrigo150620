...
var style_EvolucinIndicedeVegetacin_3 = function(feature, resolution){
    ...
    if (value >= -0.699202 && value <= -0.510625) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.510625 && value <= -0.322047) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.322047 && value <= -0.133469) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.133469 && value <= 0.055109) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.055109 && value <= 0.243687) {
            style = [ new ol.style.Style({
