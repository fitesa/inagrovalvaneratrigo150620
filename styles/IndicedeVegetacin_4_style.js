...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.073730 && value <= 0.219413) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.219413 && value <= 0.365096) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.365096 && value <= 0.510778) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.510778 && value <= 0.656461) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.656461 && value <= 0.802144) {
            style = [ new ol.style.Style({
